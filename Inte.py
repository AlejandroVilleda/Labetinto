...
# Tamaño de los cuadros en píxeles
TAMANO_CUADRO = 30

# Tamaño del muñeco en píxeles
TAMANO_MUNEQUITO = 17
...
while True:
    ...
    ventana.blit(ini_f, (14 * TAMANO_CUADRO, 1 * TAMANO_CUADRO))  # Coordenadas (14, 1) multiplicadas por el tamaño de cuadro
